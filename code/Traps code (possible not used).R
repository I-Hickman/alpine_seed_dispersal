...
##########
#####
## Q: Difference between the number of diaspores collected in bottom and top traps 
######
#Paired t-test 
...
#Violated assumptions - sqrt transform and recheck assumptions
...
wind_plot <- ggplot(wind4, aes(x = Height.above.Ground..cm., y = mean, fill = Wind)) +
  ...
  #change fill colour to red and blue
...
#Save
ggsave("output/Wind speed/Traps wind speeds plot.png", 
